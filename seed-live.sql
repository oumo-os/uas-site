...
((SELECT id FROM programmes WHERE title = 'Public Science & Space Culture' LIMIT 1), 'World Space Week 2026 - Uganda', '<p>Join the global celebration of space science and technology. UAS marks World Space Week (4-10 October) with public activities across Kampala.</p>', 2, '2026-10-04 09:00:00', '2026-10-10 18:00:00', 'Kampala - venues to be confirmed', 500, 'published', 'img/event-spaceweek-2026.jpg', 'conference', 3),
((SELECT id FROM programmes WHERE title = 'Astronomy & Observation' LIMIT 1), 'October Public Observing Night', '<p>An evening under the stars with Society telescopes. Beginners welcome; telescopes and guidance provided.</p>', 2, '2026-10-02 19:00:00', '2026-10-02 22:00:00', 'Kampala - venue to be confirmed', 200, 'published', 'img/event-nightwatch.jpg', 'observing', 3),
((SELECT id FROM programmes WHERE title = 'Astronomy & Observation' LIMIT 1), 'Annual Sky-Viewing Event', '<p>The Society flagship sky-viewing gathering, coordinated with Matovu John Baptist. Date to be confirmed.</p>', 2, '2026-12-12 19:00:00', '2026-12-12 23:00:00', 'To be confirmed', 300, 'published', 'img/event-nightwatch.jpg', 'observing', 3),
((SELECT id FROM programmes WHERE title = 'Astronomy & Observation' LIMIT 1), 'Under the Skies - Ugandan Edition', '<p>Star gazing with telescopes, planetarium shows, water rocket launch demos, and space trivia. A public astronomy evening organised in partnership with Leo Sky Africa and NLL (Stare Lions League).</p><p><strong>Venue:</strong> King''s Park Arena<br><strong>Fee:</strong> UGX 30,000</p>', 2, '2026-12-21 17:00:00', '2026-12-21 22:00:00', 'King''s Park Arena, Kampala', 300, 'published', 'img/event-undertheskies.jpg', 'observing', 3),
((SELECT id FROM programmes WHERE title = 'Astronomy Education & STEM' LIMIT 1), 'Teachers Astronomy Bootcamp', '<p>A hands-on workshop giving teachers reusable astronomy activities for their classrooms. Details to be announced.</p>', 3, '2026-11-14 09:00:00', '2026-11-14 13:00:00', 'To be confirmed', 60, 'draft', NULL, 'workshop', 3),
